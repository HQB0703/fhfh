...
const driverObj = driver({
        ...
        steps: [
            ...
            { element: '.button', popover: { title: '2 nút nhận và lì xì cho tôi', description: 'Mỗi lần ấn nhận được tôi sẽ lì xì cho 50k',     side: "bottom",
            align: 'center' } },
            { element: '.footer', popover: {   title: 'Liên Hệ' }},
        ]
    });
